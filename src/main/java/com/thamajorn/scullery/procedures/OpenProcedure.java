...
import com.thamajorn.scullery.gui.CboardGui;
...
public class OpenProcedure extends CutboardModElements.ModElement {
    public OpenProcedure(CutboardModElements instance) {
        super(instance, 3);
    }
            ...
            if (_ent instanceof ServerPlayerEntity) {
                ...
                NetworkHooks.openGui((ServerPlayerEntity) _ent, new INamedContainerProvider() {
                    ...
                    public ITextComponent getDisplayName() {
                        return new StringTextComponent("Cboard");
                    }

                    @Override
                    public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
                        return new CboardGui.GuiContainerMod(id, inventory, new PacketBuffer(Unpooled.buffer()).writeBlockPos(_bpos));
                    }
                }, _bpos);
            }
        }
